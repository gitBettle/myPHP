...
*
*/
class MInterceptor extends MInterceptorBase{
    /**
     * @brief 系统中预定的位置
     */
    ...
    */
     ...
     */
    public static function run($position,$point=null)
    {
        ...
        {
            call_user_func( array($value,$position) ,$point);
        }
    }
