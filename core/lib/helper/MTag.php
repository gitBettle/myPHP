                ...
                case 'query:':
                    {
                        ...
                        ////// 6.28 Bettle ///////
                        if(isset($attrs['cached'])) $cached = 1;
                        else $cached = 0;
                        if(isset($attrs['cachetime'])) $cachetime = $attrs['cachetime'];
                        else $cachetime = 600;
                        /////////////////////////
                        ...
                        {
                            if($k != 'cachetime' && $k != 'cached' && $k != 'name' && $k != 'id' && $k != 'items' && $k != 'item') $tem .= "{$id}->".$k.' = "'.str_replace($old_char,$new_char,$v).'";';
                        }
                        $tem .= $items.' = '.$id.'->find('.$cached.','.$cachetime.');';
